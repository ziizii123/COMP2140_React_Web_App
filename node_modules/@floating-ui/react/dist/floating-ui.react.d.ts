...
declare type BivariantCallback_2<T extends (...args: any[]) => any> = {
    bivariance(...args: Parameters<T>): ReturnType<T>;
}['bivariance'];
...
export declare interface FloatingFocusManagerProps {
     ...
     * @default true
     */
    returnFocus?: boolean | React.MutableRefObject<HTMLElement | null> | undefined;
    /**
...
export declare interface FloatingPortalProps {
     ...
     */
    root?: HTMLElement | ShadowRoot | null | React.MutableRefObject<HTMLElement | ShadowRoot | null> | undefined;
    /**
 ...
 */
export declare function useFloating<RT extends ReferenceType = ReferenceType>({ elements: elementsOption, ...options }?: UseFloatingOptions): UseFloatingReturn<RT>;
...
export declare interface UseFloatingOptions<RT extends ReferenceType = ReferenceType> extends Omit<UseFloatingOptions_2<RT>, 'elements'> {
     ...
     * closed.
     */
    onOpenChange?: BivariantCallback_2<(open: boolean, event?: Event, reason?: OpenChangeReason) => void> | undefined;
    /**
