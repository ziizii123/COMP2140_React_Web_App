...
const require_CheckboxIndicator_module = require("./CheckboxIndicator.module.cjs");
...
const CheckboxIndicator = require_factory.factory((_props) => {
	const props = require_use_props.useProps("CheckboxIndicator", defaultProps, _props);
	...
	const getStyles = require_use_styles.useStyles({
		...
		classes: require_CheckboxIndicator_module.default,
		props,
		className,
		style,
		classNames,
	...
	const ctx = (0, react.use)(require_CheckboxCard.CheckboxCardContext);
...
CheckboxIndicator.classes = require_CheckboxIndicator_module.default;
