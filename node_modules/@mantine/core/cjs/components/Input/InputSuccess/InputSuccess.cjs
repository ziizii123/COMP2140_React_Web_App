...
const varsResolver = require_create_vars_resolver.createVarsResolver((_, { size }) => ({ success: { "--input-success-size": size === void 0 ? void 0 : `calc(${require_get_size.getFontSize(size)} - ${require_rem.rem(2)})` } }));
const InputSuccess = require_factory.factory((_props) => {
	const props = require_use_props.useProps("InputSuccess", null, _props);
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(require_Box.Box, {
		component: "p",
		...getStyles("success", ctx?.getStyles ? {
			className,
			style
		} : void 0),
		...others
...
InputSuccess.classes = require_Input_module.default;
InputSuccess.varsResolver = varsResolver;
InputSuccess.displayName = "@mantine/core/InputSuccess";
//#endregion
exports.InputSuccess = InputSuccess;

//# sourceMappingURL=InputSuccess.cjs.map