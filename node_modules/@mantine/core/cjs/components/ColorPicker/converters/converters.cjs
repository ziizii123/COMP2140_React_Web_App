...
//#region packages/@mantine/core/src/components/ColorPicker/converters/converters.ts
...
function hsvaToHsl({ h, s, v, a }, includeAlpha) {
	...
	return `hsla(${result.h}, ${result.s}%, ${result.l}%, ${require_parsers.round(a, 2)})`;
}
