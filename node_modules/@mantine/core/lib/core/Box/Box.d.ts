...
export type ElementProps<ElementType extends React.ElementType, PropsToOmit extends string = never> = Omit<React.ComponentProps<ElementType>, 'style' | PropsToOmit>;
...
export declare const Box: (<C = "div">(props: import("..").PolymorphicComponentProps<C, BoxComponentProps>) => React.ReactElement) & Omit<import("react").FunctionComponent<(BoxComponentProps & {
    component?: any;
} & Omit<any, "component" | keyof BoxComponentProps> & {
    ref?: any;
