...
export declare function ModalBaseOverlay({ onClick, transitionProps, style, visible, ...others }: ModalBaseOverlayProps): import("react").JSX.Element;
export declare namespace ModalBaseOverlay {
