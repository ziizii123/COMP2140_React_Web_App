...
export declare function Saturation({ className, onChange, onChangeEnd, value, saturationLabel, focusable, size, color, onScrubStart, onScrubEnd, ...others }: SaturationProps): import("react").JSX.Element;
