...
export type ComboboxGenericData<Value extends Primitive = string> = Array<Value | ComboboxGenericItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value>>> | ReadonlyArray<Value | ComboboxGenericItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value>>>;
export type ComboboxData<Value extends Primitive = string> = Array<Value | ComboboxItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value> | ComboboxItem<Value>>> | ReadonlyArray<Value | ComboboxItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value> | ComboboxItem<Value>>>;
export type ComboboxStringGroupData<Value extends Primitive = string> = Array<Value | ComboboxItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value> | ComboboxItem<Value>, string>> | ReadonlyArray<Value | ComboboxItem<Value> | ComboboxItemGroup<Value | ComboboxGenericItem<Value> | ComboboxItem<Value>, string>>;
export type ComboboxParsedItem<Value extends Primitive = string> = ComboboxItem<Value> | ComboboxParsedItemGroup<Value>;
