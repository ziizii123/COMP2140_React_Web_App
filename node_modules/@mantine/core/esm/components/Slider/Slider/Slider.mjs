...
const Slider = factory((_props) => {
	...
	const { ref: container, active } = useMove(({ x, y }) => handleChange({ x: orientation === "vertical" ? 1 - y : x }), { onScrubEnd: handleScrubEnd }, dir);
	const callOnChangeEnd = useCallback((value) => {
